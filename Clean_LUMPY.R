...
write.table(INV_data, paste("./seqs/5_Clean_Lumpy/", strain, "_SVclean_", chromosome, ".txt", sep=""))
write.table(bedpe, paste("./seqs/5_Clean_Lumpy/", strain, "_SVall_", chromosome, ".txt", sep=""))